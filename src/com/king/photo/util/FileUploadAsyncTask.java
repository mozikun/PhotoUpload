...
public class FileUploadAsyncTask extends AsyncTask<File, Integer, String> {
  ...
  private String url = "http://118.194.161.101:5566/api/file/head/upload";
  ...
  protected String doInBackground(File... params) {
    ...
    ProgressOutHttpEntity progressHttpEntity =
        new ProgressOutHttpEntity(httpEntity, new ProgressListener() {
          @Override
  ...
  public static String uploadFile(String url, ProgressOutHttpEntity entity) {
    ...
    try {
      ...
      if (httpResponse.getStatusLine().getStatusCode() == HttpStatus.SC_OK) {
        ...
        Log.d("mozk", "httpResponse result:"+result);
